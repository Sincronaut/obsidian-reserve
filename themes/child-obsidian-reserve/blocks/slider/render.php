...
$slider_title = ! empty( $attributes['title'] ) ? $attributes['title'] : '<span class="highlight-gold">In Distinguished</span> Company.';
...
<section <?php echo $wrapper_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> style="background-color: #0B0B0B; <?php echo esc_attr( $padding_style ); ?>">
								...
								<div class="showcase-content">
									...
									<div class="showcase-buttons wp-block-buttons">
										...
										foreach ( $slide['buttons'] as $btn ) :
											$btn_style = ( 'primary' === ( $btn['style'] ?? 'primary' ) ) ? 'is-style-solid-gold' : 'is-style-outline-gold';
											?>
								...
								<div class="slide-image">
									...
									<div class="slide-dots">
										...
										for ( $i = 0; $i < $slides_count; $i++ ) :
											?>
											<span class="dot <?php echo ( 0 === $i ) ? 'active' : ''; ?>"></span>
										<?php endfor; ?>
									</div>
								</div>
	...
	<?php if ( 'showcase' === $variant && ! empty( $slides ) ) : ?>
