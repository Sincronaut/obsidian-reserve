...
/**
 * Register booking meta fields for the Booking CPT.
 *
 * @return void
 */
function obsidian_register_booking_meta() {
	...
	$fields = array(
		...
		'_booking_customer_type'   => 'string',     // Either local or international.
		'_booking_status'          => 'string',     // Status: pending_review, awaiting_payment, paid, confirmed, active, completed, denied.
		'_booking_total_price'     => 'number',     // Daily_rate times number_of_days.
		'_booking_color'           => 'string',     // Which color variant the user picked.

		// Contact and identity fields (from booking form).
		...
		'_booking_documents'       => 'string',     // JSON keys: license, gov_id, passport, proof_of_arrival.
		...
		'_booking_payment_type'    => 'string',     // down_payment or full_prepayment.
		...
		'_booking_payment_status'  => 'string',     // unpaid, paid, or deposit_released.
	);
...
function obsidian_register_car_meta() {
	...
	$car_meta = array(
		...
		'_car_galleries'      => 'string',  // JSON object keyed by color slug.
 ...
 *
 * The sanitize_text_field() function strips newlines and tabs (which is fine for JSON
