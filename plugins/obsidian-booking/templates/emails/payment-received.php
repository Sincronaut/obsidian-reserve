...
A payment has been received for the following booking.
</p>
...
<a href="<?php echo esc_url( $admin_url ); ?>" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#111111;text-decoration:none;">View Booking</a>
</td>
</tr>
</table>
